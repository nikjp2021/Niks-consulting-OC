    ...
    <section className="pt-32 pb-20 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-16">
          <p className="text-sm font-bold text-brand-500 uppercase tracking-[0.2em] mb-4">Get a Quote</p>
          <h1 className="text-5xl sm:text-6xl font-display font-bold text-ink-100 mb-6">
            Tell us about <span className="gradient-text">your project</span>
          </h1>
          <p className="text-lg text-ink-400 max-w-2xl mx-auto">Fill out the form below and we'll get back to you within 24 hours with a tailored proposal.</p>
        </motion.div>
